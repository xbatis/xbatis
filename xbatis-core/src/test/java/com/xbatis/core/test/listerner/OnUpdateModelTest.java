...
public class OnUpdateModelTest extends BaseTest {
    ...
    public void onUpdateTest() {
        try (SqlSession session = this.sqlSessionFactory.openSession(false)) {
            ...
            assertEquals("onUpdateModel", sysUserOnInsert.getUserName());
    ...
    public void onUpdatesTest() {
        try (SqlSession session = this.sqlSessionFactory.openSession(false)) {
            ...
            sysUserMapper.getBasicMapper().updateModel(Arrays.asList(sysUserOnInsert, sysUserOnInsert2));

            assertEquals("onUpdateModel", sysUserOnInsert.getUserName());
            assertNotNull(sysUserOnInsert.getCreateTime());

            assertEquals("onUpdateModel", sysUserOnInsert2.getUserName());
