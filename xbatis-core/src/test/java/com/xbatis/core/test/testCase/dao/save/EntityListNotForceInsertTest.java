...
public class EntityListNotForceInsertTest extends BaseDaoTest {
    ...
    public void notForceInsertTest1() {
        try (SqlSession session = this.sqlSessionFactory.openSession(false)) {
            ...
            getDao(sysUserMapper).save(Collections.singletonList(sysUserModel), false);
    ...
    public void notForceInsertTest2() {
        try (SqlSession session = this.sqlSessionFactory.openSession(false)) {
            ...
            sysUserModel.setRole_id(1);
            sysUserModel.setUserName(null);
            getDao(sysUserMapper).save(Collections.singletonList(sysUserModel));
            SysUser sysUser = getDao(sysUserMapper).getById(sysUserModel.getId());
            assertEquals(sysUser.getUserName(), "123456");
            assertEquals(sysUser.getRole_id(), 1);
        }
    ...
    public void notForceInsertTest3() {
        try (SqlSession session = this.sqlSessionFactory.openSession(false)) {
            ...
            sysUserModel.setRole_id(1);
            sysUserModel.setUserName(null);
            getDao(sysUserMapper).save(Collections.singletonList(sysUserModel), SysUser::getRole_id);
            SysUser sysUser = getDao(sysUserMapper).getById(sysUserModel.getId());
            assertEquals(sysUser.getUserName(), "123456");
            assertEquals(sysUser.getRole_id(), 1);
        }
