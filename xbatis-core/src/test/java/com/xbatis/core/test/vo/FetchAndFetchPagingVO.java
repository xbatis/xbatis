...
public class FetchAndFetchPagingVO {
    ...
    @Fetch(mergeGroup = "role", property = SysUser.Fields.role_id, target = SysRole.class, targetProperty = SysRole.Fields.id, targetSelectProperty = SysRole.Fields.name)
