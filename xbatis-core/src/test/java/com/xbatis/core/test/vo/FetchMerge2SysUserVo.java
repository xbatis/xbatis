...
public class FetchMerge2SysUserVo {
    ...
    @Fetch(mergeGroup = "role", property = "role_id", target = SysRole.class, targetProperty = "id", targetSelectProperty = "name")
    private String roleName;

    @Fetch(mergeGroup = "role", property = "role_id", target = SysRole.class, targetProperty = "id", targetSelectProperty = "createTime")
