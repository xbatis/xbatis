...
insert all
    into t_sys_user
values (1, 'admin', '123', 0, TO_DATE('2023-10-11 15:16:17', 'YYYY-MM-DD HH24:MI:SS'))
into t_sys_user
values (2, 'test1', '123456', 1, TO_DATE('2023-10-11 15:16:17', 'YYYY-MM-DD HH24:MI:SS'))
into t_sys_user
values (3, 'test2', null, 1, TO_DATE('2023-10-12 15:16:17', 'YYYY-MM-DD HH24:MI:SS'))
select *
from dual;

insert all
    into t_sys_role
values (1, '测试', TO_DATE('2022-10-10', 'YYYY-MM-DD'))
into t_sys_role
values (2, '运维', TO_DATE('2022-10-10', 'YYYY-MM-DD'))
select *
from dual;
...
DROP
SEQUENCE logic_delete_test_seq;
...
DROP
SEQUENCE default_value_test_seq;
...
insert all
    into fetch_merge(id,role_id1, role_id2, role_id3)
    values(1,1, 2, 3)
    into fetch_merge(id,role_id1, role_id2, role_id3)
    values(2,0, 1, 2)
    into fetch_merge(id,role_id1, role_id2, role_id3)
