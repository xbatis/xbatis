...
public class ConditionChain implements IConditionChain<ConditionChain, TableField, Cmd, Object>
    ...
    @Override
    public ConditionChain like(LikeMode mode, Cmd column, Object value) {
    ...
    @Override
    public ConditionChain notLike(LikeMode mode, Cmd column, Object value) {
    ...
    @Override
    public ConditionChain iLike(LikeMode mode, Cmd column, Object value) {
    ...
    @Override
    public ConditionChain notILike(LikeMode mode, Cmd column, Object value) {
    ...
    @Override
    public <T> ConditionChain like(boolean when, LikeMode mode, Getter<T> column, int storey, Object value) {
    ...
    @Override
    public <T> ConditionChain iLike(boolean when, LikeMode mode, Getter<T> column, int storey, Object value) {
    ...
    @Override
    public <T> ConditionChain notLike(boolean when, LikeMode mode, Getter<T> column, int storey, Object value) {
    ...
    @Override
    public <T> ConditionChain notILike(boolean when, LikeMode mode, Getter<T> column, int storey, Object value) {
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain in(List<T> list, Getter<T>... getters) {
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain in(boolean when, List<T> list, Getter<T>... getters) {
        if (when) {
            return this;
        }
        return in(list, 1, getters);
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain in(List<T> list, int storey, Getter<T>... getters) {
        this.appendCondition(conditionFactory.in(list, storey, getters));
        return this;
    }
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain in(boolean when, List<T> list, int storey, Getter<T>... getters) {
        if (when) {
            return this;
        }
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain notIn(List<T> list, Getter<T>... getters) {
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain notIn(boolean when, List<T> list, Getter<T>... getters) {
        if (when) {
            return this;
        }
        return notIn(list, 1, getters);
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain notIn(List<T> list, int storey, Getter<T>... getters) {
        this.appendCondition(conditionFactory.notIn(list, storey, getters));
        return this;
    }
     ...
     */
    @SafeVarargs
    public final <T> ConditionChain notIn(boolean when, List<T> list, int storey, Getter<T>... getters) {
        if (when) {
            return this;
        }
