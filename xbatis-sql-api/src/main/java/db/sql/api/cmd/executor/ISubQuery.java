 ...
 * @param <UNION>
 */
public interface ISubQuery<SELF extends ISubQuery<SELF, TABLE, TABLE_FIELD, DATASET_FIELD, COLUMN, V, CMD_FACTORY, CONDITION_CHAIN, WITH, SELECT, FROM, JOIN, ON, WHERE, GROUPBY, HAVING, ORDERBY, LIMIT, FORUPDATE, FORSHARE, UNION>,
