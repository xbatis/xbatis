...
public interface IOrderByCmdDescMethod<SELF extends IOrderByCmdDescMethod, COLUMN extends Cmd> extends IOrderByCmdMethod<SELF, COLUMN> {
    ...
    default SELF orderByDesc(boolean when, COLUMN column) {
        return this.orderBy(when, descOrderByDirection(), column);
    }
