...
public interface IOrderByMultiGetterDescMethod<SELF extends IOrderByMultiGetterDescMethod, TABLE extends ITable<TABLE, TABLE_FIELD>, TABLE_FIELD extends ITableField<TABLE_FIELD, TABLE>> extends IOrderByMultiGetterMethod<SELF, TABLE, TABLE_FIELD> {
